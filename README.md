...
Note that Gemini is called with a fresh context for each application of a mental model.  This means that previous analyses will not prejudice the results, so each application of a different model will be a fresh take.
## Usage  
